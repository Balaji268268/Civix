            ...
            <div className="relative" ref={rightDropdownRef}>
              ...
              <div className="relative">
                <button
                  ...
                  className="flex items-center justify-center w-10 h-10 rounded-xl bg-green-50 dark:bg-green-950/50 hover:bg-green-100 dark:hover:bg-green-900/50 transition-colors duration-300 relative"
                >
