...
const Footer = () => {
  ...
  const socialLinks = [
    {
      name: "GitHub",
      href: "https://github.com/TechBalaji/Civix",
      icon: Github,
    ...
    {
      name: "LinkedIn",
      href: "https://www.linkedin.com/in/venkata-balaj",
      icon: Linkedin,
            ...
            <div className="space-y-4">
              ...
              >
                <div className="relative">
                  <div
                    className={`absolute -inset-3 bg-gradient-to-r from-emerald-400 to-blue-500 rounded-full opacity-0 group-hover:opacity-15 blur-lg transition-all duration-500 ${hoveredItem === "logo" ? "opacity-15" : ""
                      }`}
                  ></div>
                  <img
                    src={logoF}
          ...
          <div className="space-y-4">
            ...
            <div className="space-y-3">
              ...
              >
                ...
                <span>venkatabalaji529@gmail.com</span>
              </a>
              <a
                href="tel:+916304187514"
                className="flex items-center space-x-2 text-slate-600 dark:text-slate-300 text-sm group transition-colors duration-300 hover:text-emerald-600 dark:hover:text-emerald-400"
              >
                <div className="w-6 h-6 bg-emerald-100 dark:bg-emerald-900/30 rounded-md flex items-center justify-center group-hover:bg-emerald-200 dark:group-hover:bg-emerald-800/50 transition-colors duration-300">
                  <Phone className="w-3 h-3 text-emerald-600 dark:text-emerald-400" />
                </div>
                <span>+91 6304187514</span>
              </a>
              ...
              <div className="flex flex-wrap justify-center items-center gap-2">
                {emojis.map((item, index) => (
                  <button
                    ...
                    className={`group relative p-3 rounded-xl transition-all duration-300 transform ${selectedRating === index ? "scale-110" : "hover:scale-105"
          ...
          <div className="flex flex-col md:flex-row justify-between items-center space-y-4 md:space-y-0">
            ...
            <div className="flex items-center space-x-4 text-slate-500 dark:text-slate-400 text-xs">
              ...
              <div className="flex items-center space-x-1">
                <span>Built by</span>
                <a
                  href="https://github.com/TechBalaji"
                  target="_blank"
                  rel="noopener noreferrer"
                  ...
                  aria-label="Visit Venkata Balaji's GitHub profile"
                >
                  <span>Venkata Balaji</span>
