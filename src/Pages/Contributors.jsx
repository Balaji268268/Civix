  ...
  useEffect(() => {
    const fetchContributors = () => {
      const hardcodedContributors = [
        {
          login: "TechBalaji",
          avatar_url: "/assets/balaji_profile.jpg", // Using local asset
          html_url: "https://github.com/TechBalaji",
          contributions: 500, // Giving a high contribution count as requested to be the contributor
          type: "User",
        }
      ];

      setContributors(hardcodedContributors);
      setFilteredContributors(hardcodedContributors);
      setDisplayedContributors(hardcodedContributors);
      setHasMore(false);
      setStats({
        totalContributors: 1,
        totalContributions: 500,
        topContributor: hardcodedContributors[0],
      });
      setIsLoading(false);
    };
    fetchContributors();
