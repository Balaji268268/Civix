    ...
    const fetchAnalytics = async () => {
      try {
        ...
        const [statsRes, aiRes] = await Promise.all([
          csrfManager.secureFetch('/api/admin/analytics', { headers: { 'Authorization': `Bearer ${token}` } }),
          csrfManager.secureFetch('/api/admin/community-insights', { headers: { 'Authorization': `Bearer ${token}` } })
        ]);
